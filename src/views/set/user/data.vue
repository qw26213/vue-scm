<template>
  <div class="app-container">
    ...
    <assignCust ref="custTable" :tit="handleObj.userName + handleObj.userAccount" type="user" :show-modal.sync="showModal" :handle-obj="handleObj" @handleAssign="handleAssignCust" />
    <assignItem ref="itemTable" :tit="handleObj.userName + handleObj.userAccount" type="user" :open-modal.sync="openModal" :handle-obj="handleObj" @handleAssign="handleAssignItem" />
  </div>
</template>
<script>
import { getUserList, getRole } from '@/api/user'
