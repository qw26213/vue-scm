        ...
        <div class="dataTable">
            <el-form :inline="true" label-position="right" label-width="72px" style="width: 100%; margin-top:0px;">
                <el-form-item label="单据日期:" prop="billDate">
                    <el-date-picker :editable="false" v-model="temp.billDate" :disabled="!status" type="date" placeholder="单据日期" size="small" :clearable="false" value-format="yyyy-MM-dd">
                    </el-date-picker>
                </el-form-item>
                ...
                <el-form-item label="合计金额:" prop="amount">
                    <el-input size="small" v-model="temp.amount" placeholder="合计金额" disabled/>
                </el-form-item>
