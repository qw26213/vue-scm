<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input size="small" v-model="listQuery.warehouseName" placeholder="仓库名称" style="width: 200px;" class="filter-item" />
      <el-input size="small" v-model="listQuery.warehouseCode" placeholder="仓库代码" style="width: 200px;" class="filter-item" />
