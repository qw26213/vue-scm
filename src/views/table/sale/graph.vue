...
<script>
import { getSaletable, getAggregate, getQueryConfList, saveQueryConf, deleteTemplateById } from '@/api/table'
...
export default {
    ...
    methods: {
        ...
        delItem(id) {
            deleteTemplateById(id).then(res => {
