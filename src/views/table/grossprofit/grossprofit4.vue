<template>
    <div class="app-container">
        <div class="filterDiv">
            ...
            <el-date-picker :editable="false" v-model="listQuery.date1" type="date" placeholder="开始日期" size="small" :clearable="false" value-format="yyyy-MM-dd" />
            <span class="zhi">至</span>
            <el-date-picker :editable="false" v-model="listQuery.date2" type="date" placeholder="结束日期" size="small" :clearable="false" value-format="yyyy-MM-dd" />
