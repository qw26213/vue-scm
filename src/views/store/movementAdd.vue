        ...
        <div class="dataTable">
            <el-form :inline="true" label-position="right" label-width="64px" style="width: 100%; margin-top:0px;">
                ...
                <el-form-item label="移出车辆:" prop="outTruckId">
                    <truckList @selectChange="selectChange" keyType="outTruckId" :selectId="temp.outTruckId" />
                </el-form-item>
                <el-form-item label="移入车辆:" prop="inTruckId">
                    <truckList @selectChange="selectChange" keyType="inTruckId" :selectId="temp.inTruckId" />
                </el-form-item>
                <el-form-item label="业务员:" prop="staffId">
                    <staffList @selectChange="selectChange" :selectId="temp.staffId" />
                </el-form-item>
            </el-form>
        </div>
