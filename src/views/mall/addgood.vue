  ...
  <div class="formDiv">
    <el-form ref="dataForm" label-width="120px" :rules="rules" :model="goodForm">
      ...
      <el-form-item label="商品图片" prop="attachment">
        <div v-for="url in srcList1" :key="url.fileUrl" class="itemUrl" :style="{'background-image': 'url('+url.fileUrl+')'}" />
      ...
      <el-form-item label="详情图片" prop="attachment">
        <div v-for="url in srcList2" :key="url.fileUrl" class="itemUrl" :style="{'background-image': 'url('+url.fileUrl+')'}" />
