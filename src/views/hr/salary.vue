复制往期薪酬<template>
    <div class="app-container">
        ...
        <el-dialog title="薪酬导入" :visible.sync="dialogVisible2" width="460px">
            <el-form ref="importForm" :model="importForm" :rules="rules" label-position="left" label-width="80px" style="margin-left:10px;width:400px">
                ...
                <p style="margin-top:28px">注：覆盖本期已存在的员工薪酬数据</p>
            </el-form>
            <div slot="footer" class="dialog-footer" align="center">
...
<script>
import { getPayData, delPayData, getNationalityType, getCertificateType, saveEmployee, paydetailImport, exportSalary } from '@/api/hr'
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                periodCode: [{ required: true, message: '请选择月份', trigger: 'change' }],
                fileName: [{ required: true, message: '请选择要导入的文件', trigger: 'change' }]
            },
    ...
    methods: {
        ...
        copyPay(row) {
            this.temp1.periodStar = row.periodCode
