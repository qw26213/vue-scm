...
<script>
import { getAggregate, getPurchaseTable, getPurchaseQueryConfList, savePurchaseQueryConf, delPurchaseTemplate, exportPurchaseBook, printPurchaseBook } from '@/api/table'
