    ...
    <div class="app-container">
        <div class="dataTable">
            <el-form :inline="true" label-position="right" label-width="72px" style="width: 100%; margin-top:0px;">
                ...
                <el-button size="small" class="filter-item" type="primary" @click="showSaleBill">选择销售单</el-button>
            </el-form>
        </div>
        ...
        <el-dialog :close-on-click-modal="false" title="选择销售单" :visible.sync="dialogFormVisible1" width="960px">
            <div class="filter-container">
                ...
                <span class="zhi" style="font-weight:bold; margin:0 5px">客户</span>
