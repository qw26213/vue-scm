<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input size="small" v-model="listQuery.supplierName" placeholder="供应商名称" style="width: 200px;" class="filter-item" />
      <el-input size="small" v-model="listQuery.supplierCode" placeholder="供应商代码" style="width: 200px;" class="filter-item" />
