<template>
  <div class="app-container">
    <div class="filterDiv">
      <el-input v-model="listQuery.priceGroupName" size="small" placeholder="价格组名称" style="width: 200px;" class="filter-item" />
      <el-input v-model="listQuery.priceGroupCode" size="small" placeholder="价格组代码" style="width: 200px;" class="filter-item" />
    ...
    <div class="contentDiv">
      <el-table :key="tableKey" v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%;" size="small">
        ...
        <el-table-column label="操作" align="center" width="260">
          <template slot-scope="{row}">
            <el-button type="text" size="small" @click="handleAssign(row)">分配客户</el-button>
    ...
    <assignCust ref="custTable" :tit="handleObj.priceGroupName + handleObj.priceGroupCode" type="group" :show-modal.sync="showModal" :handle-obj="handleObj" @handleAssign="handleAssignCust" />
  </div>
</template>
<script>
