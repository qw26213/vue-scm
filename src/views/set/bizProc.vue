<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input size="small" v-model="listQuery.bizProcName" placeholder="业务流程名称" style="width: 200px;" class="filter-item" />
      <el-input size="small" v-model="listQuery.bizProcCode" placeholder="业务流程代码" style="width: 200px;" class="filter-item" />
