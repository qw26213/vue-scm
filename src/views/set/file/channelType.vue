<template>
  <div class="main">
    ...
    <div class="app-container">
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%;" size="small" row-key="id">
          ...
          <el-table-column label="操作" align="left" width="250">
            <template slot-scope="{row}">
              ...
              <el-button v-if="row.leaf==1" type="text" size="small" @click="handleAssign(row)">分配客户</el-button>
            </template>
          </el-table-column>
        </el-table>
      ...
      <assignCust ref="custTable" :tit="handleObj.channelTypeName + handleObj.channelTypeCode" type="channel" :show-modal.sync="showModal" :handle-obj="handleObj" @handleAssign="handleAssignCust" />
    </div>
  </div>
</template>
