    ...
    <el-dialog :close-on-click-modal="false" title="编辑企业信息" :visible.sync="dialogFormVisible1" width="750px">
      <el-form ref="dataForm" :rules="rules" :model="enterpriseForm" inline label-position="top" label-width="120px" style="width:720px;">
        ...
        <el-form-item label="商城管理员" prop="staffId">
          <staffList :select-id="enterpriseForm.staffId" @selectChange="selectChange" />
        </el-form-item>
        <el-form-item label="虚拟客户" prop="custId">
          <custList :select-id="enterpriseForm.custId" @selectChange="selectChange" />
        </el-form-item>
        <el-form-item label="选择仓库" prop="warehouseId">
          <warehouseList :select-id="enterpriseForm.warehouseId" @selectChange="selectChange" />
        </el-form-item>
        <el-form-item label="申请日期" prop="applicationDate">
          <el-date-picker v-model="enterpriseForm.applicationDate" :editable="false" type="date" placeholder="申请日期" style="width:225px" size="small" :clearable="false" value-format="yyyy-MM-dd" />
        </el-form-item>
        <el-form-item label="正式上线日期" prop="onlineDate">
          <el-date-picker v-model="enterpriseForm.onlineDate" :editable="false" type="date" placeholder="正式上线日期" style="width:225px" size="small" :clearable="false" value-format="yyyy-MM-dd" />
        </el-form-item>
