...
<script>
import { getPurchase,savePurchase,delPurchase,auditPurchase} from '@/api/store'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getPurchase(this.listQuery).then(response => {
    ...
    handleAdd(obj) {
      ...
      this.temp.id = ''
      this.temp.purchaseName = ''
      this.temp.purchaseCode = ''
    ...
    handleCompile(obj) {
      ...
      this.temp.id = obj.id
      this.temp.purchaseName = obj.purchaseName
      this.temp.purchaseCode = obj.purchaseCode
