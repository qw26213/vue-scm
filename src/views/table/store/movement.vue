<template>
  <div class="app-container">
    <div class="filterDiv">
      ...
      <truckList key-type="outTruckId" place-txt="源车辆" ctr-type="list" :select-id="listQuery.outTruckId" @selectChange="selectChange" />
      <label class="label ml10">目标车辆</label>
      <truckList key-type="inTruckId" place-txt="目标车辆" ctr-type="list" :select-id="listQuery.inTruckId" @selectChange="selectChange" />
