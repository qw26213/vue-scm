<template>
    <el-select v-model="curId" style="width:145px" placeholder="选择供应商" size="small" @change="changeVal">
        <el-option v-for="item in list" :label="item.supplierName" :key="item.id" :value="item.id"></el-option>
    </el-select>
</template>
<script>
