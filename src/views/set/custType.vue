...
<div class="main">
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-input size="small" v-model="listQuery.custTypeName" placeholder="客户类别名称" style="width: 200px;" class="filter-item" />
      <el-input size="small" v-model="listQuery.custTypeCode" placeholder="客户类别代码" style="width: 200px;" class="filter-item" />
