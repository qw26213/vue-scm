...
<script>
import { getAggregate6, getGrossProfitTable6, getQueryConfList6, getDefaultQueryConf6, saveQueryConf6, delGrossProfitTemplate, exportGrossProfitBook, printGrossProfitBook } from '@/api/table'
