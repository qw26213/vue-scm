...
<script>
import { getAggregate, getWarehousingEntryReturnedTable, getWarehousingEntryReturnedQueryConfList, getDefaultWarehousingEntryReturnedQueryConf, saveWarehousingEntryReturnedQueryConf, delWarehousingEntryReturnedTemplate, exportWarehousingEntryReturnedBook, printWarehousingEntryReturnedBook } from '@/api/table'
...
export default {
    ...
    methods: {
        ...
        delItem(id) {
            delWarehousingEntryReturnedTemplate(id).then(res => {
        ...
        saveTemplate(obj) {
            ...
            saveWarehousingEntryReturnedQueryConf(data).then(res => {
                if (res.data.errorCode == 0) {
                    this.getTemplateList()
        ...
        getTemplateList() {
            getWarehousingEntryReturnedQueryConfList().then(res => {
                this.templatelist = res.data.data || []
            })
        },
        exportBook() {
            exportWarehousingEntryReturnedBook(this.listQuery)
        },
        printBook() {
            printWarehousingEntryReturnedBook(this.listQuery).then(res => {
        ...
        getList() {
            ...
            getWarehousingEntryReturnedTable(this.listQuery).then(res => {
                this.listLoading = false
