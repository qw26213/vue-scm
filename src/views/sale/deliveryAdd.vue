  ...
  <div class="app-container">
    <div class="dataTable">
      <el-form :inline="true" label-position="right" label-width="60px" style="width: 100%; margin-top:0px;">
        ...
        <el-form-item label="客户:" prop="custId">
          <custList key-type="custId" :contact="1" :select-id="temp.custId" :select-name="temp.custName" @selectChange="selectChange" />
        </el-form-item>
    ...
    <div class="contentDiv">
      ...
      <div class="tx-c" style="margin-top:15px">
        ...
        <el-button v-else class="submitBtn" type="primary" @click="$store.dispatch('tagsView/delView', $route);$router.replace('/sale/delivery')">返 回</el-button>
      </div>
    </div>
        ...
        if (res.data.data) {
          ...
          for (var i = 0; i < res.data.data.deliveryLine.length; i++) {
            for (var j = 0; j < this.keys.length; j++) {
              ...
              const val = res.data.data.deliveryLine[i][key]
