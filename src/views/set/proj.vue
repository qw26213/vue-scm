<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input size="small" v-model="listQuery.projName" placeholder="项目名称" style="width: 200px;" class="filter-item" />
      <el-input size="small" v-model="listQuery.projCode" placeholder="项目代码" style="width: 200px;" class="filter-item" />
