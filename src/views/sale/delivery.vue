...
<script>
import { getDelivery, delDelivery, auditDelivery, buildDelivery, buildDeliveryVoucherByHeaderId, getAuditInfoByHeaderId, printByHeaderId } from '@/api/sale'
...
export default {
    ...
    methods: {
        printBill(id) {
            printByHeaderId('/so/delivery', id).then(res => {
