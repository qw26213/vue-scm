  ...
  <div class="app-container">
    <div class="dataTable">
      <el-form :inline="true" label-position="right" label-width="72px" style="width: 100%; margin-top:0px;">
        <el-form-item label="单据日期:" prop="billDate">
          <el-date-picker v-model="temp.billDate" :editable="false" :disabled="!status" type="date" placeholder="单据日期" size="small" :clearable="false" value-format="yyyy-MM-dd" />
        </el-form-item>
        <el-form-item label="单据号:" prop="billNo">
          <el-input v-model="temp.billNo" size="small" placeholder="单据号" disabled />
        </el-form-item>
        <el-form-item label="客户:" prop="custId">
          <custList disabled="1" key-type="custId" :select-id="temp.custId" :select-name="temp.custName" @selectChange="selectChange" />
        </el-form-item>
        <el-form-item label="业务员:" prop="staffId">
          <staffList disabled="1" :select-id="temp.staffId" @selectChange="selectChange" />
        </el-form-item>
        <el-form-item label="预收类型:" prop="presaleType">
          <el-select v-model="temp.presaleType" placeholder="预收类型" disabled size="small" @change="initTable">
        ...
        <el-form-item label="合计金额:" prop="amount">
          <el-input v-model="temp.amount" size="small" placeholder="合计金额" disabled />
        </el-form-item>
    ...
    <div class="contentDiv">
      ...
      <div class="tx-c" style="margin-top:15px">
        ...
        <el-button v-else class="submitBtn" type="primary" @click="$store.dispatch('tagsView/delView', $route);$router.replace('/presale/returned')">返 回</el-button>
      </div>
    </div>
...
export default {
  ...
  components: {
    staffList, custList, itemList, invCatgList, settleTypeList, measList, modalTable
  },
  data() {
    return {
      id: '',
