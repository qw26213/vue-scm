<template>
    <el-select v-model="curId" style="width:150px" placeholder="Ñ¡ÔñÆ·Àà" size="mini" @change="changeVal">
        <el-option v-for="item in resdata" :label="item.invCatgCode" :key="item.id" :value="item.id"></el-option>
    </el-select>
</template>
<script>
