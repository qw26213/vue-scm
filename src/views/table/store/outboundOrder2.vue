...
<script>
import { getAggregate, getOutboundOrderReturnedTable, getOutboundOrderReturnedQueryConfList, getDefaultOutboundOrderReturnedQueryConf, saveOutboundOrderReturnedQueryConf, delOutboundOrderReturnedTemplate, exportOutboundOrderReturnedBook, printOutboundOrderReturnedBook } from '@/api/table'
...
export default {
    ...
    methods: {
        ...
        delItem(id) {
            delOutboundOrderReturnedTemplate(id).then(res => {
        ...
        saveTemplate(obj) {
            ...
            saveOutboundOrderReturnedQueryConf(data).then(res => {
                if (res.data.errorCode == 0) {
                    this.getTemplateList()
        ...
        getTemplateList() {
            getOutboundOrderReturnedQueryConfList().then(res => {
                this.templatelist = res.data.data || []
            })
        },
        exportBook() {
            exportOutboundOrderReturnedBook(this.listQuery)
        },
        printBook() {
            printOutboundOrderReturnedBook(this.listQuery).then(res => {
