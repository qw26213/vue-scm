<template>
  <div class="app-container">
    <div class="filterDiv">
      ...
      <el-date-picker v-model="listQuery.date1" :editable="false" type="date" placeholder="开始日期" size="small" :clearable="false" value-format="yyyy-MM-dd" />
      <span class="zhi">至</span>
      <el-date-picker v-model="listQuery.date2" :editable="false" type="date" placeholder="结束日期" size="small" :clearable="false" value-format="yyyy-MM-dd" />
...
<script>
import { getData4 } from '@/api/table'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getData4(this.listQuery).then(res => {
