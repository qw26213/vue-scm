<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input size="small" v-model="listQuery.catogeryName" placeholder="凭证字名称" style="width: 200px;" class="filter-item" />
      <el-input size="small" v-model="listQuery.catogeryCode" placeholder="凭证字代码" style="width: 200px;" class="filter-item" />
...
export default {
  ...
  methods: {
    getList() {
      ...
      getCatogery(this.listQuery).then(response => {
